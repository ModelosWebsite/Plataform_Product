...
@section("title", "Elementos Web Site")
@section("content")
                    ...
                    <div class="col-xl-12 col-lg-6">
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body d-flex">
                                <div class="col-xl-6">
                                    <form action="{{route("plataform.product.admin.elements.store")}}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="qtd" class="form-control" placeholder="Insira o numero correspondente...">
                                        </div>
                                ...
                                <div>
                                    @foreach ($elements as $element) 
                                        <div class="fform-group">
                                            <h5>{{$element->element}} : {{$element->level}}</h5>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
