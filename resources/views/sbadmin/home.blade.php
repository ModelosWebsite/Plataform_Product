        ...
        <div class="container-fluid" style="margin-top: 8rem">
            <div class="row col-xl-12 d-flex justify-content-center align-content-center">
                ...
                <div class="text-center">
                    ...
                    <h5>Link de acesso do seu site para partilhar nas redes socias: <a target="_blank" href="http://127.0.0.3:8000/{{Str::lower(auth()->user()->company->companyhashtoken)}}">https://prod.fortcodedev.com/{{Str::lower(auth()->user()->company->companyhashtoken)}}</a></h5>
                </div>
