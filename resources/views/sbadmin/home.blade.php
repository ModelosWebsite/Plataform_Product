            ...
            <div class="container-fluid" style="margin-top: 3rem; margin-bottom:3rem;">
                <div class="row col-xl-12 d-flex justify-content-center align-content-center">
                    ...
                    <div class="text-center mb-2">
                        ...
                        <h5 class="text-lg text-sm">Link de acesso do seu site para partilhar nas redes socias: <a id="share-link" target="_blank" href="{{ env('APP_URL') }}/{{ Str::lower(auth()->user()->company->companyhashtoken) }}">https://prod.fortcodedev.com/{{Str::lower(auth()->user()->company->companyhashtoken)}}</a></h5>
