<ul class="navbar-nav bg-primary sidebar sidebar-dark accordion shadow-lg" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li
        class="nav-item {{ Route::current()->getName() == 'plataform.product.admin.index' ? 'bg-white text-primary' : '' }}">
        <a class="nav-link d-flex align-items-center {{ Route::current()->getName() == 'plataform.product.admin.index' ? 'text-primary fw-bold' : '' }}"
            href="{{ route('plataform.product.admin.index') }}">
            <i
                class="fas fa-fw fa-tachometer-alt me-2 {{ Route::current()->getName() == 'plataform.product.admin.index' ? 'text-primary' : '' }}"></i>
            <span>Dashboard</span>
        </a>
    </li>
    ...
    <!-- Nav Item - Logout -->
    <li
        class="nav-item {{ Route::current()->getName() == 'plataform.product.logout' ? 'bg-white text-primary' : '' }}">
...
<a class="collapse-item d-flex align-items-center btn-flutuante" href="#" data-toggle="modal"
    data-target="#helpXzero">
