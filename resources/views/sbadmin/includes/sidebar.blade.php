<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - Dashboard -->
    <li class="nav-item {{(Route::current()->getName() == "plataform.product.admin.loja.online") ? "bg-white" : ""}}">
        <a class="nav-link {{(Route::current()->getName() == "plataform.product.admin.loja.online") ? "text-primary" : ""}}" href="{{route("plataform.product.admin.loja.online")}}">
            <i class="fas fa-fw fa-tachometer-alt"></i>
    ...
    <li class="nav-item {{(Route::current()->getName() == "plataform.product.admin.delivery.status") ? "bg-white" : ""}}">
        <a class="nav-link {{(Route::current()->getName() == "plataform.product.admin.delivery.status") ? "text-primary" : ""}}" href="{{route("plataform.product.admin.delivery.status")}}">
            <i class="fas fa-fw fa-tachometer-alt"></i>
    ...
    <li class="nav-item">
        ...
        <div id="definition" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item {{(Route::current()->getName() == "plataform.product.admin.hero") ? "text-primary" : ""}}" href="{{route("plataform.product.admin.hero")}}">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Hero</span>
                </a>
