    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="">
                <form action="{{route("plataform.product.admin.question.update", $item->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="description" placeholder="Insira o nome dpo projecto..." value="{{$item->description}}">
                  </div>
