                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td style="padding: 30px;">
                            <h2 style="font-size: 20px; color: #333333; margin-top: 0;">Olá, {{ $dataInfo['name'] }}!</h2>
                            <p style="font-size: 16px; line-height: 1.6; color: #555555;">
                                Sua conta foi criada com sucesso. Para ativá-la, clique no botão abaixo para confirmar:
                            </p>
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin: 20px 0;">
                                <tr>
                                    <td style="background-color: #f8f9fa; padding: 20px; border-radius: 6px; text-align: center;">
                                        <h3 style="font-size: 18px; color: #333333; margin: 0 0 10px 0;">Código de Verificação</h3>
                                        <p style="font-size: 22px; font-weight: bold; color: #007bff; margin: 0;">
                                            {{ $dataInfo['verification_token'] }}
                                        </p>
                                        <p style="font-size: 14px; color: #777777; margin-top: 15px;">
                                            Este código expira em 15 minutos. Se você não solicitou a criação de conta, ignore este e-mail.
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" align="center" style="margin: 30px auto;">
                                <tr>
                                    <td align="center" bgcolor="#007bff" style="border-radius: 6px;">
                                        <a href="{{ url('/verificar/conta') }}" target="_blank" style="font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; padding: 12px 24px; display: inline-block; border-radius: 6px;">
                                            Verificar Conta
                                        </a>
                                    </td>
                                </tr>
