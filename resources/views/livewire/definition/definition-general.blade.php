                    ...
                    <div class="card-body">
                        <div class="row">
                            <main>
                                ...
                                <label for="tab2">1. Temas</label>

                                <input id="tab1" type="radio" name="tabs">
                                <label for="tab1">2. Conteúdo</label>

                                <input id="tab3" type="radio" name="tabs">
                                <label for="tab3">3. Fotos</label>

                                <input id="tab6" type="radio" name="tabs">
                                <label for="tab6">4. Pagamento/Entrega</label>
                                    
                                <input id="tab4" type="radio" name="tabs">
                                <label for="tab4">5. Habilitar Website</label>

                                <input id="tab5" type="radio" name="tabs">
                                <label for="tab5">6. Minha Conta</label>
    ...
    <div class="modal fade" id="infoXzero" tabindex="-1" aria-labelledby="infoXzeroLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                <p class="mb-3">
                    Para garantir que a sua loja funcione corretamente, é obrigatório preencher os seguintes dados no portal <strong>xZero</strong> em definições da empresa:
                </p>
