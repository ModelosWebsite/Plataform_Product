...
<div>
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-header bg-primary py-3 flex-row align-items-center justify-content-between col-xl-12">
                        <div class="col-xl-12 d-flex justify-content-between">
                            <div>
                                <h4 class="m-0 font-weight-bold text-white">Temas</h4>
                            </div>
                            <div>
                            <!-- Button trigger modal -->
                            <button type="button" class="btn bg-white text-primary" data-toggle="modal" data-target="#addTheme">
                                Adicionar
                            </button>
                            ...
                            <tbody>
                                @forelse($themes as $theme)
                                    <tr>
                                        ...
                                        <td>{{$theme->version ?? ''}}</td>
                                        <td>
                                            <button class="btn btn-primary" wire:click="edit({{ $theme->id }})" data-toggle="modal" data-target="#addTheme">
                                                Editar
                                            </button>
                                            <button class="btn btn-danger" wire:click="deleteTheme({{ $theme->id }})">
                                                Editar
                                            </button>
                                        </td>
                                    </tr>
    ...
    @include("modals.superadmin.create-theme")
</div>