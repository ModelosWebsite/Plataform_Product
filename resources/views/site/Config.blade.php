                                ...
                                <div class="col-md-4 col-4 col-xl-4">
                                        ...
                                        <div>
                                            <form id="statusForm" action="{{ route('admin.update.status.company') }}" method="POST">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="status" id="statusCheckbox" {{ $statusSite->status === 'enable' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form id="status" action="{{ route('items.updateStatus') }}" method="POST">
                                            ...
                                            @method('PUT')
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="status" id="statusTerm" {{ isset($termPbs->status) === 'enable' ? 'checked' : '' }}>
