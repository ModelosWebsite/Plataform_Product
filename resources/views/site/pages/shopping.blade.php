...
@section('content')
    ...
    <a href="{{route("plataforma.produto.shoppingcart", ["company" => $companyName->companyhashtoken])}}" id="cartcout" style="color: #fff;background: var(--color);" class="cartcout d-flex align-items-center justify-content-center">      
